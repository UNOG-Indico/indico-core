 ...
 * :class:`~indico.modules.regform.models.forms.RegistrationForm` - the actual registration form. There can
   be several per event;
 * :class:`~indico.modules.regform.models.items.RegistrationFormItem` - those can be fields or sections
   (personal or not). Sections can contain "children" (fields). They specialize into
   :class:`~indico.modules.regform.models.form_fields.RegistrationFormField`,
   :class:`~indico.modules.regform.models.form_fields.RegistrationFormPersonalDataField`,
   :class:`~indico.modules.regform.models.items.RegistrationFormSection` and
   :class:`~indico.modules.regform.models.items.RegistrationFormPersonalDataSection`;
 ...
 * :class:`~indico.modules.regform.models.form_fields.RegistrationFormFieldData` - this represents the
...
.. automodule:: indico.modules.regform.models.form_fields
    :members:
    :undoc-members:

.. automodule:: indico.modules.regform.models.forms
    :members:
    :undoc-members:
...
.. automodule:: indico.modules.regform.models.items
    :members:
    :undoc-members:
