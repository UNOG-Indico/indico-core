...
from indico.modules.regform.models.form_fields import RegistrationFormField
from indico.modules.regform.models.items import RegistrationFormItemType, RegistrationFormText
...
class GeneralFieldDataSchema(mm.Schema):
    ...
    def _check_show_if_id(self, field_id, **kwargs):
        from indico.modules.regform.models.form_fields import RegistrationFormItem
        if field_id is None:
            return
        field = self.context['field']
