...
from indico.modules.regform.models.form_fields import RegistrationFormField, RegistrationFormFieldData
...
def dummy_reg_with_file_field(db, dummy_event, dummy_regform, dummy_user, create_file):
    ...
    def create_file_field():
        ...
        with patch('indico.modules.regform.models.form_fields.RegistrationFormFieldData',
