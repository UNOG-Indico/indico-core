...
# Log ACL changes
signals.acl.entry_changed.connect(make_acl_log_fn(Location, None), sender=Location, weak=False)
signals.acl.entry_changed.connect(make_acl_log_fn(Room, None), sender=Room, weak=False)
