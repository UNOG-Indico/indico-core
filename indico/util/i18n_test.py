...
@pytest.mark.parametrize(('string', 'expected_origin_string'), (
...
def test_orig_string(string, expected_origin_string):
    assert orig_string(string) == expected_origin_string
